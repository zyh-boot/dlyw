package com.cx.common.xss;

import com.cx.common.utils.JsoupUtil;
...
public class XssHttpServletRequestWrapper extends HttpServletRequestWrapper {
    ...
    private static final String NAME = "WithHtml";
    ...
    public String getParameter(String name) {
        Boolean nameFlag = CONTENT.equals(name) || name.endsWith(NAME);
        if (nameFlag && !isIncludeRichText) {

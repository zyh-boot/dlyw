 ...
 */
@CommonEndPoint
public class  CommonMetricsEndpoint {

    private static final int INT_2 = 2;
    private final MeterRegistry registry;

    public CommonMetricsEndpoint(MeterRegistry registry) {
    ...
    public apsMetricResponse metric(String requiredMetricName, List<String> tag) {
        ...
        return new apsMetricResponse(requiredMetricName, meterId.getDescription(),
    ...
    private Tag parseTag(String tag) {
        String[] parts = tag.split(StringPool.COLON, INT_2);
        if (parts.length != INT_2) {
    ...
    private Collection<Meter> findFirstMatchingMeters(CompositeMeterRegistry composite,
        ...
        return composite.getRegistries().stream()
                .map(reg -> findFirstMatchingMeters(reg, name, tags))
    ...
    private Map<String, Set<String>> getAvailableTags(Collection<Meter> meters) {
        Map<String, Set<String>> availableTags = new HashMap<>(16);
    ...
    public static final class apsMetricResponse {
        ...
        apsMetricResponse(String name, String description, String baseUnit,

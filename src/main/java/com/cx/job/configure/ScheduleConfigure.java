...
@Slf4j
@Configuration
@ConditionalOnProperty(prefix = "spring", name = "quartzFlag", havingValue = "true", matchIfMissing = true)
public class ScheduleConfigure {
    ...
    public SchedulerFactoryBean schedulerFactoryBean() {
        ...
        factory.setSchedulerName("aps_Scheduler");
        // 延时启动

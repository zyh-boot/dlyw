...
public class NettyWriteUtils {
    ...
    public static void writeToClient(final String receiveStr, ChannelHandlerContext channel, final String mark) {
        try {

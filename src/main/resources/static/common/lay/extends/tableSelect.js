layui.define(['table', 'jquery', 'form'], function (exports) {
    ...
    tableSelect.prototype.render = function (opt) {
        ...
        var getCheckedData = opt.hasOwnProperty("checkedData") ? opt.checkedData : function () {
            return [];
        };
        //默认设置
        ...
        elem.off('click').on('click', function (e) {
            ...
            opt.table.skin = 'line';
            opt.table.limit = 10;
            opt.table.limits = [5, 10, 20, 30, 40, 100];
            ...
            $(document).mouseup(function (e) {
               var userSet_con;
                if((opt.elem instanceof $)){
                    if(opt.elem[0].id){
                        userSet_con =$('#'+opt.elem[0].id+',.tableSelect');
                    }else{
                        userSet_con = $('.tableSelect')
                    }
                }else{
                    userSet_con = $('' + opt.elem + ',.tableSelect');
                }
     ...
     * 隐藏选择器
     */
    tableSelect.prototype.fottmer = function (opt) {
